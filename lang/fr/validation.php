...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => "Le :attribute indiqué apparaît dans une fuite de données connue. Veuillez choisir un autre :attribute.",
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'federation_name' => 'dénomination de la fédération',
        'arrete_numero' => "numéro de l'arrêté de validation",
        'arrete_date' => "date de l'arrêté de validation",
